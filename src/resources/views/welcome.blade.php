    ...
    <div class="max-w-3xl mx-auto px-6 space-y-24">
        ...
        <section class="min-h-[60vh] flex flex-col justify-center text-center space-y-8" x-data="{ show: false }" x-init="setTimeout(() => show = true, 500)">
            <div class="space-y-2">
                ...
                <h1 class="text-5xl md:text-7xl font-black text-white font-['Orbitron'] tracking-tight leading-none opacity-0 transition-all duration-1000 delay-700 transform translate-y-4" :class="{ 'opacity-100 translate-y-0': show }">
                    FORGE YOUR <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500">LEGACY</span>
                </h1>
            </div>
            ...
            <p class="text-lg md:text-xl text-slate-400 font-['Space_Mono'] leading-relaxed max-w-xl mx-auto opacity-0 transition-all duration-1000 delay-1000" :class="{ 'opacity-100': show }">
                The galaxy is not what it used to be. The corporations rule the void, and the pirates rule the lanes. 
                <span class="text-white">Who will you become in the chaos?</span>
            </p>

            <div class="pt-8 opacity-0 transition-all duration-1000 delay-[1500ms]" :class="{ 'opacity-100': show }">
                <a href="#" class="group relative inline-flex items-center gap-3 px-8 py-3 bg-transparent border border-white/20 hover:border-white/50 text-white text-sm font-bold uppercase tracking-[0.2em] transition-all hover:bg-white/5">
        ...
        <section class="space-y-16 border-l border-white/10 pl-8 md:pl-12 relative">
            ...
            <article class="relative group">
                ...
                <div class="space-y-4">
                    <header class="flex items-center gap-4">
                        <span class="text-blue-400 font-mono text-xs">SECTOR 7 // UPDATE</span>
                    ...
                    <p class="text-slate-400 leading-loose font-light text-lg max-w-2xl">
                        The Galactic Council has officially ratified the expansion into Sector 7. 
                        Initial scans indicate <span class="text-white font-medium">high-yield titanium deposits</span> in the outer rim. 
                        Mining guilds are already mobilizing fleets. The rush is on.
                    </p>
            ...
            <article class="relative group">
                ...
                <div class="space-y-4">
                    <header class="flex items-center gap-4">
                        <span class="text-yellow-600 font-mono text-xs">ECONOMY // ALERT</span>
                    ...
                    <p class="text-slate-400 leading-loose font-light text-lg max-w-2xl">
                        A massive surplus delivery by the "Red Star" transport guild has crashed Titanium prices in Alpha Centauri. 
                        Traders are advised to <span class="text-white font-medium">hold stock</span> or divert to secondary markets immediately.
                    </p>
                </div>
            </article>
                ...
                <div class="bg-white/5 border border-white/10 p-6 backdrop-blur-sm rounded-sm max-w-md">
                    ...
                    <div class="grid grid-cols-2 gap-8">
                        <div>
                            ...
                            <div class="text-[10px] text-slate-500 uppercase tracking-widest">Active Pilots</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-white font-['Rajdhani']">{{ now()->format('H:i') }}</div>
                            <div class="text-[10px] text-slate-500 uppercase tracking-widest">Server Time</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <article class="relative group">
                ...
                <div class="space-y-4">
                    <header class="flex items-center gap-4">
                        <span class="text-purple-400 font-mono text-xs">RECRUITMENT // OPEN</span>
                    </header>
        ...
        <section class="text-center space-y-6 pt-12 pb-24">
            <h3 class="text-2xl font-bold text-white font-['Orbitron']">READY TO JOIN?</h3>
            <div class="flex justify-center gap-8 text-sm font-bold uppercase tracking-widest font-['Rajdhani']">
                <a href="#" class="text-blue-500 hover:text-white transition-colors">Discord</a>
                <a href="#" class="text-blue-500 hover:text-white transition-colors">Manifesto</a>
                <a href="#" class="text-blue-500 hover:text-white transition-colors">Register</a>
            </div>
        </section>
